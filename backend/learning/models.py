...
class Chapter(models.Model):
    """
    Top-level learning chapter for an uploaded document.

    Relationship:
        Document -> Chapter -> LearningModule / MicroModule
    """
    ...
    # Stable pointer back to heading extracted from source document
    source_heading_index = models.PositiveIntegerField(null=True, blank=True)

    # Actual extracted source material
...
class LearningModule(models.Model):
    """
    A learning module / subsection belongs to a chapter.
    """
    class Status(models.TextChoices):
        NOT_STARTED = "not_started", "Not Started"
        IN_PROGRESS = "in_progress", "In Progress"
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_module_order_per_chapter",
            )
        ]
...
class MicroModule(models.Model):
    """
    Micro-module entity used for AI tutoring sessions, assessments, and tracking.
    """
    class Status(models.TextChoices):
        NOT_STARTED = "not_started", "Not Started"
        IN_PROGRESS = "in_progress", "In Progress"
...
class Assessment(models.Model):
    class AssessmentType(models.TextChoices):
        MICRO_MODULE = "micro_module", "Micro Module"
    ...
    assessment_type = models.CharField(
        ...
        default=AssessmentType.MICRO_MODULE,
    )
    chapter = models.ForeignKey(
        Chapter,
        on_delete=models.CASCADE,
    ...
    chapter_id_ref = models.CharField(max_length=128, blank=True)
